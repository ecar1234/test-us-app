    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Selector<FirebaseMessagingProvider, List<FirebaseMessagingEntity>>(
              ...
              return Column(
                children: [
                  Row(
                      ...
                      children: [
                        SizedBox(height: 28, child: TextButton(onPressed: (){
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Text(notifications[idx].data!['type'] == 'recruit' ? '테스터 모집' : '리뷰 관리',
                                        style: TextStyle(color: Theme.of(context).colorScheme.primary, fontWeight: FontWeight.bold),),
                                      SizedBox(
                                        height: 28,
                                        child: TextButton(onPressed: (){
                                          context.read<FirebaseMessagingProvider>().removeNotification(notifications![idx].id!);
                                        }, style: TextButton.styleFrom(
                                            padding: EdgeInsets.zero,
                                        ), child: Text('삭제')),
                                      )
                                  ...
                                  Text('${notifications[idx].data!['postTitle']?? 'title'} 알림',
                                    style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),maxLines: 1, overflow: TextOverflow.ellipsis,),
                                  const Gap(4),
