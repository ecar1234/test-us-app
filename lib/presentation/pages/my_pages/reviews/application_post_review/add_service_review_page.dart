...
class _AddServiceReviewPageState extends State<AddServiceReviewPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(title: Text("서비스 리뷰 작성")),
          ...
          child: BlocConsumer<ReviewBloc, ReviewState>(
            listener: (context, state) {
              if (state is CreateRecruitPostReviewCompletedState) {
                context.read<ReviewProvider>().addApplyPostReview(state.review);
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                ...
                                context.read<ReviewBloc>().add(
                                  CreateRecruitPostReviewEvent(token, review),
                                );
                              },
  ...
  Future<void> _alertDialog(BuildContext context) {
    return showDialog(
      ...
      builder: (context) => OneButtonAlert(
        title: '피드백 전송',
        mainContent: '개발자님께 피드백이 전송되었습니다',
        subContent: '감사합니다.',
        buttonName: '확인',
        onPressed: () {
