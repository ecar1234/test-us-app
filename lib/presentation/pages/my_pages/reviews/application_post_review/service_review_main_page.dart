...
class _ServiceReviewMainPageState extends State<ServiceReviewMainPage> {
  ...
  Future<void> _checkReviewedModal(BuildContext context, RecruitPostEntity post) {
    final review = post.reviews!.firstWhere((element) => element.reviewerUserId == context.read<UserProvider>().user!.id!);
        ...
        builder: (BuildContext context) {
          return Dialog(
            ...
            child: Container(
                ...
                child: Column(
                  children: [
                    Text('${post.title}', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis,),
                    const Gap(20),
                    RatingBar.builder(
