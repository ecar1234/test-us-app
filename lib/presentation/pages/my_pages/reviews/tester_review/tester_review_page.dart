...
class _TesterReviewPageState extends State<TesterReviewPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(title: Text("테스터 리뷰")),
            ...
            if (state is GetRecruitPostTestersReviewState) {
              ...
              return ListView.separated(
                ...
                itemBuilder: (context, idx) {
                  final isActive = info[idx].user!.status == UserStatus.active;
                  return Stack(
                    children: [
                      Container(
                        ...
                        child: Column(
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  width: 50,
                                  child: CircleAvatar(
                                    backgroundImage: state.info[idx].user!.profileImg == null || !isActive
                                ...
                                Column(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          isActive ? state.info[idx].user!.nickname! : '알 수 없는 유져',
                            ...
                            if (isActive) ...[
                              const Gap(10),
                              Selector<ReviewProvider, UserReviewEntity>(
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () {
                                        if (review.reviewId == null) {
                                          Get.to(
                                            () => AddTesterReviewPage(
                                              tester: state.info[idx].user!,
                                              appId: state.info[idx].appId!,
                                            ),
                                          );
                                        } else {
                                      ...
                                      child: Text(review.reviewId == null ? '리뷰 남겨주기' : '작성 리뷰 확인하기'),
                                    ),
                                  );
                                },
                              ),
                      ...
                      Selector<ReviewProvider, List<UserReviewEntity>>(
                        selector: (context, provider) {
                          if (provider.testersReviewOnPost == null || provider.testersReviewOnPost!.isEmpty) {
                            return [];
                          }
                          ...
                          if (review.isNotEmpty) {
                            return Positioned(
                              ...
                              child: SizedBox(
                                height: 50,
                                width: 50,
                                child: Icon(Symbols.task_alt, color: Colors.green, size: 40),
                              ),
                            );
                          }
        ...
        return Dialog(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  '${isActive ? tester.nickname : '알 수 없는 유져'} 전송된 리뷰',
                ...
                SizedBox(
                  height: hei * 0.3,
                  child: TextField(controller: _contentController, readOnly: true, minLines: 20, maxLines: 30),
                ),
                const Gap(20),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
