            ...
            return BlocListener<AppBloc, AppState>(
              listener: (context, state) {
                ...
                if (state.state == UserAppState.applicationCancelCompletedState) {
                  appProvider.cancelApplication(state.application!, state.newPost!);
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: Text(posts[idx].title!, style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600,),
    ...
    if (state == ApplicationStatus.pending) {
      ...
      return Container(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text('테스터 신청 거부', style: TextStyle(color: Colors.grey))
          ],
        )
      );
      ...
      return Container(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text('승인 완료(테스트 중)', style: TextStyle(color: Colors.grey))
            ],
          )
      );
    }
