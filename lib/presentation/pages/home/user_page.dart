...
class _UserPageState extends State<UserPage> {
          ...
          body: SingleChildScrollView(
            ...
            child: SizedBox(
              ...
              child: Column(
                children: [
                  //image section
                  _userInfoSection(context, hei),
                  const Gap(20),
                  // info section
                  _infoTableSection(context, hei, isDarkMode),
                  const Gap(20),
                  // menu section
                  _menuSection(context, hei, isDarkMode),
                ],
              ),
            ),
          )),
          ...
          builder: (context, isLogged, child) => Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 16, height: 30, child: const VerticalDivider()),
                  // 나의 홍보
                  SizedBox(
                      width: (MediaQuery.sizeOf(context).width - 60) * 0.3,
                      child: Column(
  ...
  IconData _getIcon(int idx) {
    switch (idx) {
      ...
      case 6:
        return Symbols.developer_board;
      default:
