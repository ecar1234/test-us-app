...
abstract class RecruitPostRepository{
  Future<Map<String, List<RecruitPostEntity>>> getPostInitData();
  ...
  Future<RecruitPostEntity> createPost(String token, RecruitPostEntity post);
  Future<RecruitPostEntity> updatePost(String token, RecruitPostEntity post);
