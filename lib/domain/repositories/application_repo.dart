...
abstract class ApplicationRepository {
  Future<ApplicationEntity> requestApply(String token, ApplicationEntity application);
  Future<ApplicationEntity> applyCancel(String token, int appId);
  Future<ApplicationEntity> updateApplication(String token, ApplicationEntity application);
